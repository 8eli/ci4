...
<body>
   ...
   <div class="container-fluid bg-custom mt-2">
         <div class="row ру-5" style= "height:280px">
           <div class="col">
             <img src="/assets/image/1X1 PICTURE_BACUS.jpg" class="rounded-circle" style="width:250px" alt="picture of myself"/>
           </div>
      ...
      <div id="hobby" class="bg-custom text-light">
         ...
         <div class="row py" style="height:400px">
            <div class="col text-start">
               ...
               <img src="/assets/image/20230315_162254.gif" class= alt="" height="300" width="500">
            </div>
            <div class="col text-start">
               <div class="fs-4 fw-bold mb-3">Skills</div>  
               <img src="/assets/image/20230315_165609.gif" class= alt="" height="300" width="500">
            </div>
            </div>
         </div>
         </div>
