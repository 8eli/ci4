...
<body>
   ...
   <div class="container-fluid  bg-custom mt-2">
      <div class="row ру-5" style="height:280px">
         <div class="col-3">
            <img id="poto" src="/assets/image/download.png" class="rounded-circle" style="width:250px" alt="picture of myself" />
         </div>
   ...
   <div class="container text-center">
      <form action="<?= base_url('table-store')?>" method="POST" id="CommentForm">
